    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-12">
          <motion.a 
            href="mailto:vincxxdev@gmail.com" 
          ...
          >
            ...
            <span className="text-xl font-semibold group-hover:text-accent transition-colors duration-300">vincxxdev@gmail.com</span>
          </motion.a>
          
          <motion.a 
            href="tel:PHONE_REMOVED" 
            className="flex flex-col items-center gap-4 text-primary-text group"
            whileHover={{ scale: 1.05 }}
            transition={{ type: 'spring', stiffness: 300 }}
          >
            ...
            <span className="text-xl font-semibold group-hover:text-accent transition-colors duration-300">PHONE_REMOVED</span>
          </motion.a>
        </div>
      </div>
    </section>
